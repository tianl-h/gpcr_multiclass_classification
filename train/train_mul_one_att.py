# -*- coding: utf-8 -*-
# @Author: tianl
# @Date:   2021-03-02 22:18:39
# @Last Modified by:   tianl
# @Last Modified time: 2021-03-03 19:48:32
...
def main():
    ...
    data = {'Atompair': data_by_atts['Atompair'], 'ECFP6': data_by_atts['ECFP6'], 'MACCS': data_by_atts['MACCS'], 'Physicochemical Properties': data_by_atts['PC']}
    data = {'Atompair': data_by_atts['Atompair']}
    data = {'ECFP6': data_by_atts['ECFP6'], 'MACCS': data_by_atts['MACCS'], 'Physicochemical Properties': data_by_atts['PC']}
    ...
    for att, d in data.items():
        ...
        for method, func_and_hyper in METHODS_WITH_HYPER.items():
            ...
            for att, m_dict in metrics.items():
                file = open(os.path.join('results_one_att/Validation_Radar/', att + "_metrics_test.txt"), "w")
        ...
        #     autosize=True,
            ...
            for att, m_dict in metrics.items():
                ...
                radar_chart.write_image("results_one_att/Validation_Radar/" + att + ".png")
                radar_chart.data = []
